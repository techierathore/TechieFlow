---
name: techieflow-log-miss
description: Record one missed requirement as telemetry and a checklist line. Use when a TechieFlow project needs its `log-miss` workflow.
---

# techieflow-log-miss

1. Read `.tfcore/tasks/log-miss.md` completely and follow it as the canonical executable workflow.
