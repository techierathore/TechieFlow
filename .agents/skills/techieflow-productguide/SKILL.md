---
name: techieflow-productguide
description: Create the user-facing guide from the running application. Use when a TechieFlow project needs its `productguide` workflow.
---

# techieflow-productguide

1. Read `.tfcore/tasks/productguide.md` completely and follow it as the canonical executable workflow.
