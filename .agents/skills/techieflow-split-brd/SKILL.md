---
name: techieflow-split-brd
description: Convert a BRD into the single implementation checklist. Use when a TechieFlow project needs its `split-brd` workflow.
---

# techieflow-split-brd

1. Read `.tfcore/tasks/split-brd.md` completely and follow it as the canonical executable workflow.
