---
name: techieflow-metrics-report
description: Report TechieFlow development telemetry without changing code. Use when a TechieFlow project needs its `metrics-report` workflow.
---

# techieflow-metrics-report

1. Read `.tfcore/tasks/metrics-report.md` completely and follow it as the canonical executable workflow.
