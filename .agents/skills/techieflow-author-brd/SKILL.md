---
name: techieflow-author-brd
description: Interactively author or extend numbered business requirements. Use when a TechieFlow project needs its `author-brd` workflow.
---

# techieflow-author-brd

1. Read `.tfcore/tasks/author-brd.md` completely and follow it as the canonical executable workflow.
