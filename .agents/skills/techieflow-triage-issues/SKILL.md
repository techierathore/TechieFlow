---
name: techieflow-triage-issues
description: Analyze and document human-found bugs without fixing source. Use when a TechieFlow project needs its `triage-issues` workflow.
---

# techieflow-triage-issues

1. Read `.tfcore/tasks/triage-issues.md` completely and follow it as the canonical executable workflow.
